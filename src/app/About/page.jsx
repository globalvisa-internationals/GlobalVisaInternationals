            ...
            <main className={styles.container}>
                ...
                <section className={styles.visaTypes}>
                    ...
                    <ul>
                        ...
                        <li>Permanent Resident Visa (PR)</li>
                        <li>Transit Visa</li>
                ...
                {/* Services */}
                <section className={styles.visaTypes}>
                    <h2>Additional Services We Handle</h2>
                    <ul>
                ...
                <section className={styles.vision}>
                    ...
                    <div className={styles.values}>
                        <div className={styles.value}>
                            ...
                            <p className={styles.valuep}>To be a globally trusted name in visa consulting through consistent results and client success.</p>
                        </div>
                        <div className={styles.value}>
                            <h4>02. Simplified Solutions</h4>
                            <p className={styles.valuep}>To simplify complex visa processes with expert, technology-driven guidance.</p>
                        </div>
                        <div className={styles.value}>
                            <h4>03. Integrity & Transparency</h4>
                            <p className={styles.valuep}>To uphold honesty, clarity, and customer satisfaction in every step of the journey.</p>
                        </div>
                        <div className={styles.value}>
                            <h4>04. Life-Changing Opportunities</h4>
                            <p className={styles.valuep}>To create meaningful opportunities for students, professionals, and families worldwide.</p>
                        </div>
                    </div>
                </section>
