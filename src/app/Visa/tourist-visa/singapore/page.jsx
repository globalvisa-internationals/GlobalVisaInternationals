      ...
      <div className={styles.VisaSec}>
        ...
        <div className={styles.VisaData}>
          ...
          <ul >
            ...
            <li className={styles.card1}><b className={styles.strong}>ingapore Zoo:</b> Discover the wonders of wildlife at the Singapore Zoo, renowned for its open-concept enclosures and diverse animal exhibits.</li>
