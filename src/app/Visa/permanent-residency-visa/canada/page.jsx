  ...
  return (
    <>
      <head>
        ...
        <title>Canada PR Visa Consultants in Bangalore | Requirements, Cost & Application Process from India | Global Visa Internationals</title>
        <meta name="description" content="Dreaming of Canada PR from Bangalore? Global Visa Internationals offers expert guidance on Canada Permanent Residency (PR) visa requirements, application process, cost, and pathways for skilled workers and families from India." />
        <meta name="keywords" content="Canada PR visa consultants Bangalore, Canada permanent residency India, apply for Canada PR from India, Canada PR cost, Canada immigration consultants Bangalore, Canada PR process, Canada PR requirements, Express Entry Canada, PNP Canada, skilled migration Canada, best Canada PR consultants" />
        ...
        {/* Open Graph / Facebook */}
        <meta property="og:title" content="Canada PR Visa Consultants Bangalore: Requirements, Cost & Application | Global Visa Internationals" />
        <meta property="og:description" content="Plan your move to Canada from Bangalore. Global Visa Internationals provides expert assistance for Canada Permanent Residency (PR) visa applications, including Express Entry and PNP pathways. Get detailed guidance on requirements and costs." />
        <meta property="og:url" content="https://www.globalvisainternationals.com/visa/permanent-residency/canada" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://www.globalvisainternationals.com/images/canada-pr-visa-banner.jpg" />
        <meta property="og:locale" content="en_IN" />
        <meta property="og:locale:alternate" content="en_US" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Canada PR Visa from India | Your Guide to Permanent Residency in Bangalore" />
        <meta name="twitter:description" content="Migrate to Canada with confidence from Bangalore! Global Visa Internationals offers comprehensive support for Canada PR visas, covering application steps, required documents, and eligibility criteria." />
        <meta name="twitter:image" content="https://www.globalvisainternationals.com/images/canada-pr-visa-banner.jpg" />
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Global Visa Internationals",
            "url": "https://www.globalvisainternationals.com/visa/permanent-residency/canada", // Specific page URL for this service
            "logo": "https://www.globalvisainternationals.com/logo.png",
            "description": "Trusted Canada PR visa consultants in Bangalore helping Indian skilled workers and families achieve Canada Permanent Residency (PR) with expert application and documentation support.", // Added Bangalore context
            "address": {
              "@type": "PostalAddress",
        ...
        {/* Structured Data - BreadcrumbList Schema - No changes needed, already good */}
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "BreadcrumbList",
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "The cost of a Canada PR visa from India includes various fees such as the application fee (currently CAD 850 for principal applicant), Right of Permanent Residence Fee (CAD 515), biometric fees, educational credential assessment (ECA), and language test fees (IELTS/CELPIP). Total costs can range significantly depending on family size and additional requirements. For a detailed breakdown, contact our Canada PR visa consultants in Bangalore." // Added Bangalore context
                }
              },
              {
                "@type": "Question",
                "name": "What documents are required for Canada PR from Bangalore?", // Added Bangalore context
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Key documents for Canada PR include a valid passport, educational credential assessment (ECA) report, language test results (IELTS/CELPIP/TEF), proof of skilled work experience, police clearance certificates, medical examination results, and proof of funds. Additional documents may be required based on the specific immigration program. Our Canada immigration consultants in Bangalore can provide a personalized document checklist." // Added Bangalore context
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Canada PR visa processing times vary depending on the immigration program (e.g., Express Entry, PNP), the completeness of your application, and IRCC's current workload. It can range from 6 months for Express Entry to over a year for other programs. Official IRCC website provides the most up-to-date processing times. Global Visa Internationals in Bangalore stays updated on all processing changes." // Added Bangalore context
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Express Entry is an online system used by Immigration, Refugees and Citizenship Canada (IRCC) to manage applications for permanent residence under federal economic immigration programs like the Federal Skilled Worker Program, Federal Skilled Trades Program, and Canadian Experience Class. Candidates are ranked based on a Comprehensive Ranking System (CRS) score. Our experts in Bangalore can help you maximize your CRS score." // Added Bangalore context
                }
              },
              {
                "@type": "Question",
                "name": "Why choose Global Visa Internationals as your Canada PR visa consultants in Bangalore?", // New FAQ
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Global Visa Internationals is a leading visa consultancy in Bangalore with over 11+ years of experience in Canada PR applications. We offer personalized guidance, comprehensive support for Express Entry & PNP, transparent cost breakdowns, and a high success rate to help you achieve your Canadian immigration goals."
                }
              }
            ]
          })
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Service",
            "serviceType": "Canada Permanent Residency Visa Application Assistance in Bangalore", // Added Bangalore here
            "provider": {
              "@type": "Organization",
              "name": "Global Visa Internationals",
              "url": "https://www.globalvisainternationals.com"
            },
            "areaServed": [ // Changed to an array to include specific cities/countries
              {
                "@type": "City",
                "name": "Bengaluru"
              },
            ...
            "hasOfferCatalog": {
              "@type": "OfferCatalog",
              "name": "Canada Permanent Residency Visa Services", // More specific name
              "itemListElement": [
                {
                  "@type": "Offer",
                  "itemOffered": {
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Canada Immigration Consulting in Bangalore" // Added local service
                  }
                },
                {
                  "@type": "Offer",
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Canada PR Document Preparation Bangalore" // Added local service
                  }
                }
              ]
            }
